...
function StlViewer(e, t) {
    ...
    this.error = null, this.options = t, this.parent_element = e, this.get_opt = function (e, t) {
        ...
        var t = new Worker("/js/" + "load_stl.min.js");
        ...
        if (s && s.mesh && s.mesh.geometry) {
            var n = Math.max(s.scalex, .01), r = Math.max(s.scaley, .01), l = Math.max(s.scalez, .01);
        ...
        o.WORLD_X_VECTOR = new THREE.Vector3(1, 0, 0), o.WORLD_Y_VECTOR = new THREE.Vector3(0, 1, 0), o.WORLD_Z_VECTOR = new THREE.Vector3(0, 0, 1), o.edges_material = new THREE.LineBasicMaterial({color: 0}), o.raycaster = new THREE.Raycaster, o.mouse = new THREE.Vector2, o.scene = new THREE.Scene, o.is_webgl = webgl_Detector.webgl, o.renderer = o.is_webgl ? new THREE.WebGLRenderer({
        ...
        } else for (i = 0; i < r; i++) n.push(new THREE.Face3(t[i][0], t[i][1], t[i][2]));
